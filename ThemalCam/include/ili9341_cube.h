...
#define LCD_WRX_LOW()              	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_RESET)
#define LCD_WRX_HIGH()              HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0, GPIO_PIN_SET)
#define LCD_CS_LOW() 				HAL_GPIO_WritePin(BUS_SPI2_NSS_GPIO_PORT, BUS_SPI2_NSS_GPIO_PIN, GPIO_PIN_RESET)
#define LCD_CS_HIGH() 				HAL_GPIO_WritePin(BUS_SPI2_NSS_GPIO_PORT, BUS_SPI2_NSS_GPIO_PIN, GPIO_PIN_SET)
/**
  * @}
  */
